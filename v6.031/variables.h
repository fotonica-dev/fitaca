...
static char strTiposLinea[Idiomas][NumeroTiposLinea][LongitudMaximaStringTipoLinea] = {
	{"Texto", "Gráfico", "Texto circular", "Código 128", "Código 39", "EAN", "Datamatrix", "ITF-14", "QR" },
...
// Almacena los números de los tipos de línea: 10 tipos; los dos primeros corresponden a texto y gráfico
